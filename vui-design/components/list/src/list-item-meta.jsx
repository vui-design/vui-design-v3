  ...
  render(h) {
    ...
    children.push(
      <div class={classes.elContent}>
        <div class={classes.elTitle}>{slots.title ? slots.title() : props.title}</div>
        <div class={classes.elDescription}>{slots.description ? slots.description() : props.description}</div>
      </div>
    );
