<template>
  <vui-example id="example-descriptions-bordered" v-bind:code="code">
    <template v-slot:title>带边框的</template>
    <template v-slot:description>
      <p>带边框和背景颜色的描述列表。</p>
    </template>
    <template v-slot:demo>
      <div class="example-descriptions-bordered">
...
<style>
  .example-descriptions-bordered .vui-descriptions p { margin:0; }
</style>