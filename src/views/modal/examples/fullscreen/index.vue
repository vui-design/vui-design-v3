<template>
  <vui-example id="example-modal-fullscreen" v-bind:code="code">
    <template v-slot:demo>
      <div class="example-modal-fullscreen">
    ...
    <template v-slot:title>全屏显示</template>
    <template v-slot:description>
      <p>取消默认的垂直居中，并使用 <code>top</code> 属性来设置对话框的打开位置。</p>
    </template>
  </vui-example>
</template>
