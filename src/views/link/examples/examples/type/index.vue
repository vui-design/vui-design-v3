<template>
  <vui-example id="example-link-type" v-bind:code="code">
    <template v-slot:title>链接类型</template>
    <template v-slot:description>
      <p>文字链接包含六种类型。一般情况下，我们将 <code>primary</code> 类型用于主链接，而次链接使用 <code>default</code> 类型。</p>
    </template>
