<template>
  <vui-example id="example-link-link" v-bind:code="code">
    <template v-slot:title>链接导航</template>
    <template v-slot:description>
      <p>属性 <code>href</code> 用于设置文字链接点击后的跳转地址，指定此属性后文字链接的点击行为将和原生 <code>a</code> 链接保持一致。</p>
    </template>
