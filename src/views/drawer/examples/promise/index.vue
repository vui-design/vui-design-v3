<template>
  <vui-example id="example-drawer-promise" v-bind:code="code">
    ...
    <template v-slot:description>
      <p>点击确定后异步关闭 <code>Drawer</code>，例如提交表单。</p>
      <p>当 <code>ok</code> 事件回调函数显式的返回 <code>false</code>，或返回的 <code>Promise</code> 对象被 <code>reject</code>，将阻止 <code>Drawer</code> 关闭。</p>
    </template>
  </vui-example>
</template>
