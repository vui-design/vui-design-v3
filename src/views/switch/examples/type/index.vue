<template>
  <vui-example id="example-switch-type" v-bind:code="code">
    ...
    <template v-slot:title>开关类型</template>
    <template v-slot:description>
      <p>开关分为 <code>circle</code> - 圆形（默认）、<code>round</code> - 圆角、<code>line</code> - 线性三种类型</p>
    </template>
  </vui-example>
</template>
