<template>
  <vui-example id="example-tooltip-colorful" v-bind:code="code">
    ...
    <template v-slot:title>多彩文字提示</template>
...
<style>
  ...
  .example-tooltip-colorful .vui-tooltip-list { display:flex; justify-content:flex-start; align-items:flex-start; flex-wrap:wrap; row-gap:12px; }
  .example-tooltip-colorful .vui-button { margin-right:12px; }
</style>