<template>
  <vui-article>
    ...
    <vui-grid-examples v-if="activeKey === 'examples'" />
    <vui-grid-api v-if="activeKey === 'api'" />
    <vui-grid-guide v-if="activeKey === 'guide'" />
  </vui-article>
</template>
...
<script lang="ts">
  ...
  import VuiGridExamples from "./examples/index.vue";
  import VuiGridApi from "./api/index.vue";
  import VuiGridGuide from "./guide/index.vue";
  ...
  export default defineComponent({
    ...
    setup(props, context) {
      const { activeKey, handleChange } = useSegments("/components/grid");
