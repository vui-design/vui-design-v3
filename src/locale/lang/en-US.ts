export default {
  "app": {
    ...
    "menu": {
      ...
      "feedback-notification": "Notification 通知提醒",
    ...
    "anchors": {
      ...
      "api-button-props": "Button 属性",
      "api-button-events": "Button 事件",
      "api-button-group-props": "ButtonGroup 属性",
      "guide-button-when-to-use": "何时使用",
      ...
      "api-link-props": "Link 属性",
      "api-link-events": "Link 事件",
      "guide-link-when-to-use": "何时使用",
      ...
      "api-divider-props": "Divider 属性",
      "guide-divider-when-to-use": "何时使用",

      "example-grid-basic-usage": "基本用法",
      "example-grid-gutter": "区块间隔",
      "example-grid-offset": "左右偏移",
      "example-grid-sort": "栅格排序",
      "example-grid-justify": "排版",
      "example-grid-align": "对齐",
      "example-grid-order": "排序",
      "example-grid-flex-stretch": "Flex 填充",
      "example-grid-responsive": "响应式布局",
      "example-grid-responsive-more": "其它属性的响应式",
      "example-grid-playground": "栅格配置器",
      "api-grid-row-props": "Row 属性",
      "api-grid-col-props": "Col 属性",
      "guide-grid-design-concept": "设计理念",
      "guide-grid-overview": "概述",
      "guide-grid-flex": "Flex 布局",
      "guide-grid-when-to-use": "何时使用",

      "example-layout-basic-usage": "基本用法",
      "example-layout-vertical": "上中下布局",
      ...
      "api-layout-breakpoint": "Breakpoint",
      "api-layout-props": "Layout 属性",
      "api-layout-header-props": "Header 属性",
      "api-layout-sider-props": "Sider 属性",
      "api-layout-sider-events": "Sider 事件",
      "guide-layout-design-rules": "设计规则",
      "guide-layout-when-to-use": "何时使用",
      ...
      "example-space-gutter": "间距大小",
      "example-space-customize": "自定义间距",
      "example-space-wrap": "自动换行",
      "api-space-props": "Space 属性",
      "guide-space-when-to-use": "何时使用",
      ...
      "api-anchor-props": "Anchor 属性",
      "api-anchor-events": "Anchor 事件",
      "api-anchor-link-props": "AnchorLink 属性",
      "guide-anchor-when-to-use": "何时使用",
      ...
      "api-breadcrumb-props": "Breadcrumb 属性",
      "api-breadcrumb-item-props": "BreadcrumbItem 属性",
      "api-breadcrumb-item-events": "BreadcrumbItem 事件",
      "guide-breadcrumb-when-to-use": "何时使用",
      ...
      "api-dropdown-props": "Dropdown 属性",
      "api-dropdown-events": "Dropdown 事件",
      "api-dropdown-button-props": "DropdownButton 属性",
      "api-dropdown-button-events": "DropdownButton 事件",
      "guide-dropdown-when-to-use": "何时使用",
      ...
      "api-menu-props": "Menu 属性",
      "api-menu-events": "Menu 事件",
      "api-submenu-props": "Submenu 属性",
      "api-menu-item-props": "MenuItem 属性",
      "api-menu-item-group-props": "MenuItemGroup 属性",
      "api-menu-item-divider-props": "MenuItemDivider 属性",
      "guide-menu-when-to-use": "何时使用",
      ...
      "api-page-header-props": "PageHeader 属性",
      "api-page-header-events": "PageHeader 事件",
      "guide-page-header-when-to-use": "何时使用",
      ...
      "example-pagination-simple": "简洁模式",
      "example-pagination-size": "尺寸",
      "example-pagination-align": "水平对齐方式",
      "example-pagination-hide-on-single-page": "隐藏",
      "api-pagination-props": "Pagination 属性",
      "api-pagination-events": "Pagination 事件",
      "guide-pagination-when-to-use": "何时使用",

      "example-steps-basic-usage": "基本用法",
      "example-steps-vertical": "纵向步骤条",
      "example-steps-size": "步骤条尺寸",
      "example-steps-error": "步骤运行错误",
      "example-steps-icon": "自定义图标的步骤条",
      "example-steps-dot": "点状步骤条",
      "example-steps-customized-dot": "自定义点状步骤条",
      "example-steps-navigation": "导航步骤条",
      "example-steps-clickable": "可点击",
      "example-steps-control": "切换步骤",
      "api-steps-props": "Steps 属性",
      "api-steps-events": "Steps 事件",
      "api-steps-step-props": "Step 属性",
      "guide-steps-when-to-use": "何时使用",
      ...
      "api-tabs-props": "Tabs 属性",
      "api-tabs-events": "Tabs 事件",
      "api-tabs-panel-props": "TabPanel 属性",
      "guide-tabs-when-to-use": "何时使用",

      "example-checkbox-basic-usage": "基本用法",
      "example-checkbox-disabled": "禁用状态",
      "example-checkbox-condition": "按条件勾选",
      "example-checkbox-controller": "与其它组件通信",
      "example-checkbox-state-value": "自定义状态值",
      "example-checkbox-group": "多选组合",
      ...
      "api-checkbox-props": "Checkbox 属性",
      "api-checkbox-events": "Checkbox 事件",
      "api-checkbox-group-props": "CheckboxGroup 属性",
      "api-checkbox-group-events": "CheckboxGroup 事件",
      "guide-checkbox-when-to-use": "何时使用",

      "example-input-basic-usage": "基本用法",
      "example-input-bordered": "无边框",
      "example-input-size": "尺寸",
      "example-input-show-count": "字数统计",
      "example-input-clearable": "可清空",
      "example-input-addon": "前置/后置标签",
      "example-input-affix": "前缀/后缀图标",
      "example-input-disabled": "禁用状态",
      "example-input-tooltip": "输入时格式化展示",
      "example-input-password": "密码框",
      "example-input-search": "搜索框",
      "example-input-group": "复合型输入框",
      "api-input-props": "Input / InputPassword 属性",
      "api-input-events": "Input / InputPassword 事件",
      "api-input-methods": "Input / InputPassword 方法",
      "api-input-search-props": "InputSearch 属性",
      "api-input-search-events": "InputSearch 事件",
      "api-input-group-props": "InputGroup 属性",
      "guide-input-when-to-use": "何时使用",
      ...
      "api-input-number-props": "InputNumber 属性",
      "api-input-number-events": "InputNumber 事件",
      "api-input-number-methods": "InputNumber 方法",
      "guide-input-number-when-to-use": "何时使用",

      "example-radio-basic-usage": "基本用法",
      "example-radio-disabled": "禁用状态",
      "example-radio-condition": "按条件勾选",
      "example-radio-controller": "与其它组件通信",
      ...
      "api-radio-props": "Radio 属性",
      "api-radio-events": "Radio 事件",
      "api-radio-group-props": "RadioGroup 属性",
      "api-radio-group-events": "RadioGroup 事件",
      "guide-radio-when-to-use": "何时使用",
      ...
      "api-rate-props": "Rate 属性",
      "api-rate-events": "Rate 事件",
      "guide-rate-when-to-use": "何时使用",
      ...
      "api-select-props": "Select 属性",
      "api-select-events": "Select 事件",
      "api-select-option-group-props": "OptionGroup 属性",
      "api-select-option-props": "Option 属性",
      "guide-select-when-to-use": "何时使用",

      "example-switch-type": "开关类型",
      ...
      "example-switch-condition": "按条件开/关",
      "api-switch-props": "Switch 属性",
      "api-switch-events": "Switch 事件",
      "guide-switch-when-to-use": "何时使用",

      "example-textarea-basic-usage": "基本用法",
      "example-textarea-bordered": "无边框",
      "example-textarea-show-count": "字数统计",
      "example-textarea-autosize": "适应内容高度的文本域",
      "example-textarea-resizable": "手动改变高度",
      "example-textarea-clearable": "可清空",
      "example-textarea-disabled": "禁用状态",
      "api-textarea-props": "Textarea 属性",
      "api-textarea-events": "Textarea 事件",
      "api-textarea-methods": "Textarea 方法",
      "guide-textarea-when-to-use": "何时使用",

      "example-upload-basic-usage": "基本用法",
      "example-upload-picture": "图片列表样式",
      "example-upload-picture-card": "照片墙",
      "example-upload-avatar": "用户头像",
      "example-upload-default-file-list": "默认的上传列表",
      "example-upload-controlled": "完全受控的上传列表",
      "example-upload-multiple": "批量上传",
      "example-upload-directory": "文件夹上传",
      "example-upload-draggable": "拖拽上传",
      "example-upload-accept": "允许上传的文件类型",
      "example-upload-request": "自定义上传请求",
      ...
      "api-upload-file-props": "UploadFile 说明",
      "guide-upload-when-to-use": "何时使用",
      ...
      "example-avatar-responsive": "响应式尺寸",
      "api-avatar-props": "Avatar 属性",
      "api-avatar-events": "Avatar 事件",
      "api-avatar-group-props": "AvatarGroup 属性",
      "guide-avatar-when-to-use": "何时使用",
      ...
      "example-badge-offset": "自定义位置偏移",
      "example-badge-status": "状态点",
      "example-badge-colorful": "多彩徽标",
      "api-badge-props": "Badge 属性",
      "guide-badge-when-to-use": "何时使用",
      ...
      "example-card-inner": "内部卡片",
      "example-card-in-column": "栅格卡片",
      "api-card-props": "Card 属性",
      "api-card-meta-props": "CardMeta 属性",
      "guide-card-when-to-use": "何时使用",
      ...
      "api-collapse-props": "Collapse 属性",
      "api-collapse-events": "Collapse 事件",
      "api-collapse-panel-props": "CollapsePanel 属性",
      "guide-collapse-when-to-use": "何时使用",
      ...
      "api-descriptions-props": "Description 属性",
      "api-descriptions-panel-props": "Description 属性",
      "guide-descriptions-when-to-use": "何时使用",

      "example-empty-basic-usage": "基本用法",
      "example-empty-no-description": "无描述",
      "example-empty-customize": "自定义",
      "api-empty-props": "Empty 属性",
      "guide-empty-when-to-use": "何时使用",

      "example-list-simple": "简单列表",
      "example-list-basic-usage": "基础列表",
      "example-list-loading": "加载中",
      "example-list-load-more": "加载更多",
      "example-list-vertical": "竖排列表样式",
      "example-list-grid": "栅格列表",
      "example-list-resposive": "响应式的栅格列表",
      "api-list-props": "List 属性",
      "api-list-grid-props": "List grid 属性",
      "api-list-item-props": "ListItem 属性",
      "api-list-item-meta-props": "ListItemMeta 属性",
      "guide-list-when-to-use": "何时使用",

      "example-popover-basic-usage": "基本用法",
      "example-popover-trigger": "触发方式",
      "example-popover-control": "从浮层内关闭",
      "example-popover-placement": "位置",
      "api-popover-props": "Popover 属性",
      "api-popover-events": "Popover 事件",
      "guide-popover-when-to-use": "何时使用",
      ...
      "api-qrcode-props": "Qrcode 属性",
      "api-qrcode-events": "Qrcode 事件",
      "api-qrcode-methods": "Qrcode 方法",
      "guide-qrcode-when-to-use": "何时使用",

      "example-ribbon-basic-usage": "基本用法",
      "example-ribbon-placement": "位置",
      "example-ribbon-type": "预设类型",
      "example-ribbon-colorful": "多彩缎带",
      "api-ribbon-props": "Ribbon 属性",
      "guide-ribbon-when-to-use": "何时使用",
      ...
      "api-segments-props": "Segments 属性",
      "api-segments-events": "Segments 事件",
      "api-segments-item-props": "SegmentsItem 属性",
      "guide-segments-when-to-use": "何时使用",

      "example-statistic-basic-usage": "基本用法",
      "example-statistic-icon-and-unit": "图标/单位",
      "example-statistic-card": "在卡片中使用",
      "example-statistic-extra": "附加内容",
      "example-statistic-countdown": "倒计时",
      "api-statistic-props": "Statistic 属性",
      "api-statistic-countdown-props": "Countdown 属性",
      "api-statistic-countdown-events": "Countdown 事件",
      "guide-statistic-when-to-use": "何时使用",
      ...
      "example-timeline-reverse": "控制排序的时间轴",
      ...
      "api-alert-props": "Alert 属性",
      "api-alert-events": "Alert 事件",
      "guide-alert-when-to-use": "何时使用",
      ...
      "example-drawer-promise": "基于 Promise 的异步关闭",
      "example-drawer-customized-footer": "自定义页脚",
      "example-drawer-multi-level": "多层抽屉",
      "example-drawer-get-popup-container": "渲染在当前容器",
      "api-drawer-props": "Drawer 属性",
      "api-drawer-events": "Drawer 事件",
      "guide-drawer-when-to-use": "何时使用",
      ...
      "api-message-methods": "Message 静态方法",
      "guide-message-when-to-use": "何时使用",
      ...
      "example-modal-fullscreen": "全屏显示",
      "example-modal-draggable": "可拖动",
      "example-modal-promise": "基于 Promise 的异步关闭",
      ...
      "api-modal-props": "Modal 属性",
      "api-modal-events": "Modal 事件",
      "api-modal-methods": "Modal 静态方法",
      "guide-modal-when-to-use": "何时使用",

      "example-notification-basic-usage": "基本用法",
      "example-notification-type": "提示类型",
      "example-notification-loading": "加载中",
      "example-notification-duration": "修改延时",
      "example-notification-placement": "弹出位置",
      "example-notification-update": "更新通知内容",
      "example-notification-more": "更多内容",
      "api-notification-props": "Notification 属性",
      "api-notification-events": "Notification 事件",
      "api-notification-methods": "Notification 静态方法",
      "guide-notification-when-to-use": "何时使用",

      "example-popconfirm-basic-usage": "基本用法",
      "example-popconfirm-icon": "自定义图标",
      "example-popconfirm-local": "国际化",
      "example-popconfirm-trigger-condition": "条件触发",
      "example-popconfirm-promise": "基于 Promise 的异步关闭",
      "example-popconfirm-placement": "位置",
      "api-popconfirm-props": "Popconfirm 属性",
      "api-popconfirm-events": "Popconfirm 事件",
      "guide-popconfirm-when-to-use": "何时使用",

      "example-progress-line": "进度条",
      "example-progress-line-small": "小型进度条",
      "example-progress-circle": "进度环",
      "example-progress-circle-small": "小型进度环",
      "example-progress-circle-micro": "响应式进度环",
      "example-progress-dashboard": "仪表盘",
      "example-progress-dynamic": "动态展示",
      "example-progress-segment": "分段进度条",
      "example-progress-formatter": "自定义文字格式",
      "example-progress-stroke-color": "自定义颜色",
      "example-progress-stroke-linecap": "线条边缘形状",
      "example-progress-steps": "步骤进度条",
      "api-progress-props": "Progress 属性",
      "guide-progress-when-to-use": "何时使用",
      ...
      "api-result-props": "Result 属性",
      "guide-result-when-to-use": "何时使用",
      ...
      "api-skeleton-props": "Skeleton 属性",
      "api-skeleton-avatar-props": "SkeletonAvatarProps 属性",
      "api-skeleton-title-props": "SkeletonTitleProps 属性",
      "api-skeleton-paragraph-props": "SkeletonParagraphProps 属性",
      "api-skeleton-input-props": "SkeletonInputProps 属性",
      "api-skeleton-button-props": "SkeletonButtonProps 属性",
      "api-skeleton-image-props": "SkeletonImageProps 属性",
      "guide-skeleton-when-to-use": "何时使用",
      ...
      "api-spin-props": "Spin 属性",
      "api-spin-methods": "Spin 全局方法",
      "guide-spin-when-to-use": "何时使用",

      "example-affix-basic-usage": "基本用法",
      "example-affix-change": "监听状态变化",
      "example-affix-container": "滚动容器",
      "api-affix-props": "Affix 属性",
