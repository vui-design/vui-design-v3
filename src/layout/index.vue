...
<style>
	...
	.app-layout-body-content .article { display:flex; align-items:stretch; }
	.app-layout-body-content .article-content { flex:1; overflow:hidden; color:rgba(0,0,0,0.85); font-size:14px; line-height:2; }
	.app-layout-body-content .article-content h1 { font-size:28px; font-weight:600; }
	.app-layout-body-content .article-content h2 { font-size:24px; font-weight:600; }
	.app-layout-body-content .article-content h3 { font-size:16px; font-weight:600; }
	.app-layout-body-content .article-content h4 { font-size:14px; font-weight:600; }
	.app-layout-body-content .article-content p { font-size:14px; }
	.app-layout-body-content .article-content blockquote { border-left:4px solid #e6e6e6; margin:16px 0; padding-left:12px; }
	.app-layout-body-content .article-content blockquote p { margin-bottom:0; color:rgba(0,0,0,0.45); }
	.app-layout-body-content .article-content table { width:100%; margin:16px 0; }
	.app-layout-body-content .article-content table th { border:1px solid #f0f0f0; background-color:#fafafa; padding:8px 16px; font-size:13px; text-align:left; vertical-align:top; }
	.app-layout-body-content .article-content table td { border:1px solid #f0f0f0; padding:8px 16px; font-size:13px; text-align:left; vertical-align:top; }
	.app-layout-body-content .article-content table td pre { margin:0; }
	.app-layout-body-content .article-content table.example-api-props th:nth-child(1) { white-space:nowrap; }
	.app-layout-body-content .article-content table.example-api-props th:nth-child(2) {  }
	.app-layout-body-content .article-content table.example-api-props th:nth-child(3) {  }
	.app-layout-body-content .article-content table.example-api-props th:nth-child(4) { white-space:nowrap; }
	.app-layout-body-content .article-content table.example-api-props td:nth-child(1) { font-family:"SFMono-Regular", Consolas, "Liberation Mono", Menlo, Courier, monospace; white-space:nowrap; }
	.app-layout-body-content .article-content table.example-api-props td:nth-child(2) {  }
	.app-layout-body-content .article-content table.example-api-props td:nth-child(3) { color:#ff4d4f; font-family:"SFMono-Regular", Consolas, "Liberation Mono", Menlo, Courier, monospace; }
	.app-layout-body-content .article-content table.example-api-props td:nth-child(4) { font-family:"SFMono-Regular", Consolas, "Liberation Mono", Menlo, Courier, monospace; white-space:nowrap; }
	.app-layout-body-content .article-content table.example-api-events th:nth-child(1) { white-space:nowrap; }
	.app-layout-body-content .article-content table.example-api-events th:nth-child(2) {  }
	.app-layout-body-content .article-content table.example-api-events th:nth-child(3) {  }
	.app-layout-body-content .article-content table.example-api-events th:nth-child(4) { white-space:nowrap; }
	.app-layout-body-content .article-content table.example-api-events td:nth-child(1) { font-family:"SFMono-Regular", Consolas, "Liberation Mono", Menlo, Courier, monospace; white-space:nowrap; }
	.app-layout-body-content .article-content table.example-api-events td:nth-child(2) {  }
	.app-layout-body-content .article-content table.example-api-events td:nth-child(3) { color:#ff4d4f; font-family:"SFMono-Regular", Consolas, "Liberation Mono", Menlo, Courier, monospace; }
	.app-layout-body-content .article-content table.example-api-events td:nth-child(4) { font-family:"SFMono-Regular", Consolas, "Liberation Mono", Menlo, Courier, monospace; white-space:nowrap; }
	.app-layout-body-content .article-content ul { list-style:circle; padding-left:18px; }
	.app-layout-body-content .article-content ul li p { margin-bottom:0; }
	.app-layout-body-content .article-content ol { list-style:circle; padding-left:18px; }
	.app-layout-body-content .article-content ol li { margin-bottom:4px; }
	.app-layout-body-content .article-content ol li p { margin-bottom:0; }
	.app-layout-body-content .article-content pre { margin:16px 0; }
	.app-layout-body-content .article-content code { border-radius:2px; border:1px solid #f0f0f0; background-color:#fafafa; margin:0; padding:2px 4px; color:rgba(0,0,0,0.65); font-size:13px; }
	.app-layout-body-content .article-content pre code { padding:12px 16px; }
	.app-layout-body-content .article-anchors { width:120px; margin-left:32px; }
	.app-layout-body-content .article-anchors .vui-anchor { font-size:12px; }
</style>